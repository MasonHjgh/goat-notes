    ...
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      ...
      <DialogContent className="custom-scrollbar flex h-[85vh] max-w-4xl flex-col overflow-y-auto">
        ...
        <div className="mt-4 flex flex-col gap-8">
          ...
          {isPending && <p className="animate-pulse">Thinking...</p>}
        </div>
        <div
        ...
        >
          <Textarea
            ref={textareaRef}
            className="rounded-nonne background-transparent placeholder:text-muted-foreground resize-none border-none p-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0"
